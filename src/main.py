...
def main():
    ...
    monomer_1 = Monomer(monomer_type='A', diffusion_rate=1.0, diffusion_energy=0.01, rotation_rate=0, rotation_energy=0)
    monomer_2 = Monomer(monomer_type='B', diffusion_rate=1.0, diffusion_energy=0.03, rotation_rate=0, rotation_energy=0)
